...
func main() {
	...
	type Las_status struct {
                ...
                Status string `json:"status" default:nil`
        }
        var las_status Las_status
        las_status = Las_status{ID_Scoring:23,Score:586.2,Status:"Accepted"}
        value, err := json.Marshal(las_status)
